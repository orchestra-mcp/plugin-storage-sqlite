...
func AddLabels(store *storage.FeatureStorage) ToolHandler {
	return func(ctx context.Context, req *pluginv1.ToolRequest) (*pluginv1.ToolResponse, error) {
		...
		return helpers.JSONResult(map[string]any{
			...
			"labels":     feat.Labels,
			"message":    fmt.Sprintf("Added labels to %s", featureID),
		})
	}
}
...
func RemoveLabels(store *storage.FeatureStorage) ToolHandler {
	return func(ctx context.Context, req *pluginv1.ToolRequest) (*pluginv1.ToolResponse, error) {
		...
		return helpers.JSONResult(map[string]any{
			"feature_id": featureID,
			"labels":     feat.Labels,
			"message":    fmt.Sprintf("Removed labels from %s", featureID),
		})
	}
}
...
func AssignFeature(store *storage.FeatureStorage) ToolHandler {
	return func(ctx context.Context, req *pluginv1.ToolRequest) (*pluginv1.ToolResponse, error) {
		...
		return helpers.JSONResult(map[string]any{
			"feature_id": featureID,
			"assignee":   assignee,
			"message":    fmt.Sprintf("Assigned %s to %s", featureID, assignee),
		})
	}
}
...
func UnassignFeature(store *storage.FeatureStorage) ToolHandler {
	return func(ctx context.Context, req *pluginv1.ToolRequest) (*pluginv1.ToolResponse, error) {
		...
		return helpers.JSONResult(map[string]any{
			"feature_id": featureID,
			"message":    fmt.Sprintf("Unassigned %s", featureID),
		})
	}
}
...
func SetEstimate(store *storage.FeatureStorage) ToolHandler {
	return func(ctx context.Context, req *pluginv1.ToolRequest) (*pluginv1.ToolResponse, error) {
		...
		return helpers.JSONResult(map[string]any{
			"feature_id": featureID,
			"estimate":   estimate,
			"message":    fmt.Sprintf("Set estimate for %s to %s", featureID, estimate),
		})
	}
}
